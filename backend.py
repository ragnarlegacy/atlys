...
class UserApp:
    ...
    def add_user(self):
        """
        Add a new user from the request JSON.
        """
        data = request.json
...
if __name__ == "__main__":
    os.environ["GOOGLE_APPLICATION_CREDENTIALS"] = "/Users/ragnarlothbrok/Desktop/atlys/Terraform/ragnar-07-8f816f54d8e2.json"  # Ensure correct path
    app = UserApp()
    app.run()
